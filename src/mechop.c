...
/**
 * STOP!!!!! GUTTED VERSION OF MECHOP.C
 */
...
void ChassisSet(int left, int right, bool immediate)
{
	...
	motorSet(MOTOR_CHASSIS_FRONTLEFT, left);
	motorSet(MOTOR_CHASSIS_FRONTRIGHT, right);
	motorSet(MOTOR_CHASSIS_REARLEFT, left);
	motorSet(MOTOR_CHASSIS_REARRIGHT, right);
}
